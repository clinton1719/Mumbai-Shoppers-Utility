...
public class RoleRepositoryTest {
	 ...
	 * "Manage Everything in this application"); Role savedRole =
	 * repo.save(roleAdmin);
	 * 
	 * assertThat(savedRole.getId()).isGreaterThan(0); }
	 * 
	 * 
	 * @Test public void testRemainingRoles() { Role roleSalesPerson = new
	 * Role("SalesPerson",
	 ...
	 * = new Role("Shipper", "View products, orders and update order status"); Role
	 * roleAssistant = new Role("Assistant", "Manage questions and reviews");
	 * 
